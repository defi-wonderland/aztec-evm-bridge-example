...
cd ~/nargo/github.com/AztecProtocol/aztec-packages/v0.87.2/noir-projects/noir-contracts/
...
cp ~/nargo/github.com/AztecProtocol/aztec-packages/v0.87.2/noir-projects/noir-contracts/target/token_contract-Token.json ./target/token_contract-Token.json
```
